...
import com.example.jetpackcomposepokedex.data.models.PokdexListEntry
...
class PokemonListViewModel @Inject constructor(
    ...
    var pokemonList = mutableStateOf<List<PokdexListEntry>>(listOf())
    var loadError = mutableStateOf("")
    var isLoading = mutableStateOf(false)
    var endReached = mutableStateOf(false)

    private var cachedPokemonList = listOf<PokdexListEntry>()
